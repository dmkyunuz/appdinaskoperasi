<div class="">
<form class="" method="post" action="<?= site_url('/users/create'); ?>" id="form-bentuk-koperasi">
    <fieldset>
        <div class='row'>
            <div class='col-sm-12'>
                <label>Kode</label>
                <div class='form-group'>
                    <input class="form-control required" id="kode_bk" name="kode_bk" type="text" autocomplete="off" placeholder="Kode" readonly value="">
